...
const features = [
  {
    title: 'Expert Field Engineers',
    description:
      'Our technicians are certified specialists with decades of collective experience in heavy machinery.',
    icon: (
  ...
  },
  {
    ...
    description:
      'Efficient project management systems to meet aggressive timelines without compromising quality.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      'Every installation is executed to exact specifications, ensuring long-term reliability and peak performance.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      'Single point of contact from project scoping through commissioning and ongoing AMC support.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
