...
const Navbar = () => {
  ...
  return (
    <nav
      className={`text-white sticky top-0 z-50 border-b border-white/10 transition-all duration-500 ${
        scrolled
          ? 'glass-dark shadow-3d'
          : 'bg-navy'
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          {/* Desktop Menu - Center — 3D flip hover effect */}
          ...
          <div className="hidden lg:flex items-center gap-4">
            <button
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.transform = 'translateZ(10px) scale(1.15)';
              }}
              onMouseLeave={(e) => {
