        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            {SECTIONS.map((section) => (
              <button
                ...
                className={`text-sm font-bold tracking-wider uppercase transition-all duration-300 flex flex-col items-center gap-1 ${
                  activeSection === section && !isClientsPage ? 'text-orange' : 'text-white/80 hover:text-white'
                }`}
              >
                <span>{section}</span>
                <span
                  style={{
                    ...
                    borderRadius: '1px',
                    transform: activeSection === section && !isClientsPage ? 'scaleX(1)' : 'scaleX(0)',
            ...
            <button
              ...
              className={`text-sm font-bold tracking-wider uppercase transition-all duration-300 flex flex-col items-center gap-1 ${
                isClientsPage ? 'text-orange' : 'text-white/80 hover:text-white'
              }`}
            >
              <span>Clients</span>
              <span
        ...
        <div className="lg:hidden bg-charcoal border-t border-white/10">
          <div className="px-4 pt-2 pb-3 space-y-1">
            {SECTIONS.map((section) => (
              <button
                ...
                className={`block w-full text-left px-4 py-3 font-bold tracking-wider uppercase text-sm transition ${
                  activeSection === section && !isClientsPage ? 'text-orange bg-white/5' : 'text-white hover:bg-white/5'
                }`}
              >
                {section}
              </button>
            ...
            <button
              ...
              className={`block w-full text-left px-4 py-3 font-bold tracking-wider uppercase text-sm transition ${
                isClientsPage ? 'text-orange bg-white/5' : 'text-white hover:bg-white/5'
              }`}
            >
              Clients
            </button>
