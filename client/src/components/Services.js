  ...
  const services = [
    {
      ...
      description: 'Turnkey diesel generator installations with precision engineering and commissioning.',
      icon: (
    ...
    },
    {
      ...
      description: 'Fuel supply, exhaust, and cooling circuits engineered for maximum efficiency.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    },
    {
      ...
      description: 'Control panels, synchronization, and power distribution systems.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    },
    {
      ...
      description: 'Engine maintenance, repairs, and performance optimization.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    },
    {
      ...
      description: 'High-speed diesel storage, handling, and distribution infrastructure.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    <section id="services" className="py-20 md:py-28 bg-charcoal">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div
            className="bg-orange p-8 flex flex-col justify-center items-center text-center cursor-pointer hover:bg-orange/90 transition group"
            onClick={scrollToContact}
          >
            <svg className="w-16 h-16 text-white mb-6 group-hover:scale-110 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
            ...
            <button className="bg-white text-orange font-bold px-6 py-3 text-sm uppercase tracking-wider hover:bg-gray-100 transition flex items-center gap-2">
              CONTACT US
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
              </svg>
